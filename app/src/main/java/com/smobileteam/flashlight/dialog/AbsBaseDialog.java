...
public abstract class AbsBaseDialog<T extends AbsBaseDialog> {
    ...
    public AbsBaseDialog(Context context, int theme) {
    ...
    protected class ClickListenerDecorator implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (clickListener != null) {
                if (clickListener instanceof FlashDialogCompat.DialogOnClickListenerAdapter) {
                    FlashDialogCompat.DialogOnClickListenerAdapter listener =
                            (FlashDialogCompat.DialogOnClickListenerAdapter) clickListener;
