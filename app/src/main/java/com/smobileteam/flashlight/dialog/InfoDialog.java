...
public class InfoDialog extends AbsBaseDialog<InfoDialog> {
    ...
    public InfoDialog setNotShowAgainOptionEnabled(int dialogId) {
    ...
    public InfoDialog setNotShowAgainOptionChecked(boolean defaultChecked) {
        cbDontShowAgain.setChecked(defaultChecked);
        return this;
    }

    public InfoDialog setConfirmButtonText(@StringRes int text) {
        return setConfirmButtonText(string(text));
    }

    public InfoDialog setConfirmButtonText(String text) {
        confirmButton.setText(text);
        return this;
    }

    public InfoDialog setConfirmButtonColor(int color) {
