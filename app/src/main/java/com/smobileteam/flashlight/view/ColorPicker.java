...
public class ColorPicker extends View {
    ...
    private OnColorPickerListener mOnColorPickerListene;

    public void setOnColorPickerListene(OnColorPickerListener mOnColorPickerListene) {
        this.mOnColorPickerListene = mOnColorPickerListene;
    }
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (d <= colorWheelRadius) {
                    ...
                    invalidate();
                    mOnColorPickerListene.updateColor(getColor());

                } else  {
                    mOnColorPickerListene.OnInnerWheelClick();
